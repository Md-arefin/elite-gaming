...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-base-300 text-base-content rounded-md my-10">
            <div>
                <img src="https://i.ibb.co/9H465Dg/vite-removebg-preview.png" className="rounded" alt="" />
            </div>
            <div>
                ...
                <Link to='/error' className="link link-hover">Error Page</Link>
